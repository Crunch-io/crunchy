...
This prevents unauthorized users from seeing the rendered dashboard. If the user isn't logged into 
crunch, they will see a red error message, which you can handle using `shiny::validate()`. 
